...
<head>
  ...
  <title>Add Club - JEvents</title>
</head>

<body>
  <div class="clubmain">
    <p class="sign" align="center">Add club to database</p>
    <form class="form1" action="add_club.php" method="post">
      <input type="text" name="Name" class="un " placeholder="Name">
      <input type="text" name="Description" class="un " placeholder="Description">
