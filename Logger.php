...
class Logger
{
    ...
    {
        static::$log_file =  __DIR__ . "/logs/log.txt";
    ...
    public static  function writeLog($args = [])
    {
        ...
        $browser = str_replace(",", ";", get_browser(null, true)['browser']);
        // Write time, url, & message to end of file
        fwrite(static::$file, "{$timeLog},{$pathLog},{$lineLog},{$browser},{$ip_address},{$severityLog},{$messageLog} {$contextLog}" . PHP_EOL);
