...
<head>
    ...
    <title>Search President Info by Club Name - JEvents</title>
  <script src="//code.jquery.com/jquery-1.12.4.js"></script>
  <script src="//code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
</head>

<body>
    <div class="stumain" style="height: 500px;">
        <p class="sign" align="center">Search for president's name and email for a club:</p>
